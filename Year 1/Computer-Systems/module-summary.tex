...
\definition{3.1.1}{A \underline{MIPS (Microprocessor without Interlocked Pipeline Stages)} is 32-bit RISC processor used in embedded systems and consumer electronics. It has 32 general purpose registers as seen in}

\inserttable{c|c|c}{MIPS' 32 general purpose registers}
{\textbf{Number} & \textbf{Name} & \textbf{Purpose}}
{
    0 & \(\$0\) & Stores the constant value 0.
}
