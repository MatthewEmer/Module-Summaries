...
\newcommand{\templateversion}{1.4.1} % Do not edit this variable.
...
\definition{6.1.1}{\underline{ANSI} (American National Standards Institute) and \underline{SPARC} (The Standards, Planning, and Requirements Committee).}
