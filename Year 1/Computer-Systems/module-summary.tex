...
\begin{itemize}
    ...
    \item There are also join operations, corresponding to their SQL eqivalents: inner \(\insertjoin\), left outer \(\insertleftouterjoin\), right outer \(\insertrightouterjoin\), and full outer \(\insertfullouterjoin\).
