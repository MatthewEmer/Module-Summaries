...
\newcommand{\templateversion}{1.9.1} % Do not edit this variable.
...
\newcommand{\thetitle}{Year One Lecture Notes} % Insert the document title here.
\newcommand{\thesubtitle}{Computer Science - Durham University} % Insert the document subtitle here.
...
\part{Algorithms and Data Structures}
\input{Sections/Algorithms-and-Data-Structures/module-notes.tex}

\newpage\part{Computational Thinking}

\section{Introduction to Computer Science}

\section{Logic}

\newpage\part{Computer Systems}
\input{Sections/Computer-Systems/module-notes.tex}

\newpage\part{Mathematics for Computer Science}
\input{Sections/Mathematics-for-Computer-Science/module-notes.tex}

\newpage\part{Discrete Mathematics (Elective)}
\input{Sections/Discrete-Mathematics/module-notes.tex}

\newpage\part{References}

\section{Algorithms and Data Structures}
\input{Sections/Algorithms-and-Data-Structures/references.tex}

\section{Computational Thinking}

\section{Computer Systems}
\input{Sections/Computer-Systems/references.tex}

\section{Mathematics for Computer Systems}
\input{Sections/Mathematics-for-Computer-Science/references.tex}

\section{Discrete Mathematics}
\input{Sections/Discrete-Mathematics/references.tex}
