...
\begin{itemize}
    \setcounter{enumi}{-1}
    \item RAID 0: Non-redundant striping.
    \item RAID 1: Mirrored disks.
    \item RAID 2: Memory-style error-correcting codes.
    \item RAID 3: Bit-interleaved parity.
    \item RAID 4: Block-interleaved parity.
    \item RAID 5: Block-interleaved distributed parity.
