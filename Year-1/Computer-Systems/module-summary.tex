...
\separate{7}\definition{10.3.3}{\underline{Redundant array of inexpensive disk} uses multiple disk drives to increases reliability via redundancy. It is arranged in seven levels:}
\begin{enumerate}
    \setcounter{enumi}{-1}
    \item Non-redundant striping.
    \item Mirrored disks.
    \item Memory-style error-correcting codes.
    \item Bit-interleaved parity.
    \item Block-interleaved parity.
    \item Block-interleaved distributed parity.
    \item P+Q redundancy.
\end{enumerate}
