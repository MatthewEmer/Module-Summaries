...
\definition{7.2.1}{\underline{Heapify} takes an incorrectly ordered heap and reorders it into an acceptable order.}

\algorithmBlock{The Heapify algorithm}
{\(A\), the array to turn into a heap, \(v\), the largest value, \(i\), the highest index.}
