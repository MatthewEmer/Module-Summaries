...
\separate{5}\definition{9.1.1}{A \underline{path} in a graph is a subgraph which is isomorphic to the graph \(P_k\) for some integer \(k \geq 1\).}

\separate{5}\definition{9.1.2}{A \underline{cycle} is a subgraph isomorphic to the graph \(C_k\) where \(k \geq 3\).}
