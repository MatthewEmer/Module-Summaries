...
\separate{5}\hyperref[ads:section:2.ans]{\textit{Asymptotic Notation and Sorting}} is taught by Professor Thomas Erlebach.
\begin{itemize}
...
\separate{5}\hyperref[ads:section:3.sds]{\textit{Selection and Data Structures}} is taught by Doctor Anish Jindal.
\begin{itemize}
