...
\begin{equation}
    \lim_{x \rightarrow \infty} \left(\frac{f(x)}{x}\right) = 0
\end{equation}
...
\subsection{Recursion for Sorting and Solving Recurrences}
...
\newpage\noindent\definition{4.2.1}{The \underline{Master Theorem} can be used to quickly solve recurrences of form}
\begin{equation}
